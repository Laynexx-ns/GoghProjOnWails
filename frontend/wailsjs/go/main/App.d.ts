...
export function GetGistContent(arg1:string,arg2:string):Promise<main.APIResponse>;
...
export function GetRepositoriesForAuthenticatedUser():Promise<main.APIResponse>;
